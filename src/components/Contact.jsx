function Contact() {
  return (
    <div className="py-16">
      <div className="block max-w-[1170px] p-6 bg-white rounded-lg shadow-lg dark:bg-neutral-700 w-[1170px] mx-auto grid grid-cols-2 ">
        <form>
          ...
          <button
            type="submit"
            className="w-full rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg bg-primary-mint"
            data-te-ripple-init
