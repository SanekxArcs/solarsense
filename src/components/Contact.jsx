      ...
      <div className="max-w-[1170px] p-6 rounded-sm shadow-lg  mx-auto bg-cadet-space  text-mint-cream">
        ...
        >
          ...
          >
            ...
            <textarea
              className="peer bg-mint-cream  bg-mint-cream block h-full w-full rounded-sm border-0  py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none  text-cadet-space  peer-focus:text-cadet-space"
              id="Wiadomość"
              name="Message"
              rows="3"
