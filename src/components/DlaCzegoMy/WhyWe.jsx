function WhyWe() {
  return (
    <div className="w-full px-3 mb-6 grow-0 shrink-0 basis-auto col-span-2 mb-md-0">
      <div className="flex flex-wrap">
        ...
        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12">
          <div className="flex transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="ml-4 grow">
              ...
              <p className="text-gray-500">
                Magna lacus iaculis elit, quis pharetra varius. Aenean lectus
                ex, placerat id tellus in eros.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-3 mb-12 grow-0 shrink-0 basis-auto lg:w-6/12">
          <div className="flex transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="ml-4 grow">
              <p className="mb-1 font-bold">Money back guarantee</p>
              <p className="text-gray-500">
