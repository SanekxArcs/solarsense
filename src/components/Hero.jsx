    ...
    >
      ...
      <div className="z-10 grid w-full h-screen transition-all duration-500 place-content-center lg:py-32 backdrop-blur-sm hover:backdrop-blur-none bg-rich-black bg-opacity-40 animate-text-focus-in">
        <div className="relative flex flex-col items-center justify-center gap-12 mx-auto max-h-144 max-w-[900px] text-center text-mint-cream px-5 py-10">
          ...
          <button className="z-20 px-8 py-4 text-xl font-bold transition-all duration-300 rounded-sm bg-primary-mint text-mint-cream hover:scale-125 hover:bg-cadet-space hover:shadow-md ">
            Wycena
          </button>
