function Opinia() {
  return (
    <div className="container px-6 mx-auto py-24 bg-cadet-space">
      <section className="mb-32 text-center text-gray-800 lg:text-left w-[1170px] mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-x-6 lg:gap-x-12 ">
          <div
            className="block mb-6 bg-white rounded-lg shadow-lg lg:mb-0 bg-mint-cream"
          ...
          <div className="block mb-6 bg-white rounded-lg shadow-lg lg:mb-0 bg-mint-cream">
            <div
          ...
          <div className="block bg-white rounded-lg shadow-lg bg-mint-cream">
            <div
              className="relative overflow-hidden bg-no-repeat bg-cover"
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
