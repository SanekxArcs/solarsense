    ...
    <>
          ...
          <div className="flex flex-col gap-5 ">
            ...
            <div className="flex flex-wrap gap-3 justify-stretch">
              ...
              <button onClick={btnSetOneMonth} className={`${oneMonth ? "bg-ocean-green-300" : null} px-4 py-2 font-bold transition-all border rounded-md text-ocean-green-800 border-ocean-green-700 bg-ocean-green-50 hover:shadow-md hover:shadow-ocean-green-100 hover:-translate-y-1 hover:bg-ocean-green-200`}>
                miesięczny
              </button>
              <button onClick={btnSetTwoMonth} className={`${twoMonth ? "bg-ocean-green-300" : null} px-4 py-2 font-bold transition-all border rounded-md text-ocean-green-800 border-ocean-green-700 bg-ocean-green-50 hover:shadow-md hover:shadow-ocean-green-100 hover:-translate-y-1 hover:bg-ocean-green-200`}>
                2-miesięczny
              </button>
              <button onClick={btnSetYear} className={`${year ? "bg-ocean-green-300" : null} px-4 py-2 font-bold transition-all border rounded-md text-ocean-green-800 border-ocean-green-700 bg-ocean-green-50 hover:shadow-md hover:shadow-ocean-green-100 hover:-translate-y-1 hover:bg-ocean-green-200`}>
                roczny
              </button>
            </div>
            <div>
          ...
          <div className="">
            <h4 className="mb-2 font-medium">Wpisz wysokość {year ? "rocznych": null}{twoMonth ? "2-miesięcznych": null}{oneMonth ? "miesięcznych": null} opłat</h4>
            <div>
              <div className ="w-72">
                <div className ="relative h-10 w-full min-w-[200px]">
                  <input onChange={(e) => setPriceToPay(e.target.value)}
                    ...
                    placeholder=" "
                    value={priceToPay ? priceToPay: null}
                  />
            ...
            <p className="">
            <i className="pr-2 fa-solid fa-circle-info"></i>To oznacza, że Twoje roczne zapotrzebowanie na energię elektryczną wynosi około {calculation} kWh.
                </p>
                <p>Przyjęta stawka za 1 kWh: {priceForkWp} zł<button onClick={() => setShowPriceForkWp(!showPriceForkWp)} className="pl-2 font-bold">{showPriceForkWp ? "Zwin" : "Rozwin"}</button></p>
                
                {showPriceForkWp ? <ChangePrice price={priceForkWp} setPrice={setPriceForkWp} /> : null}
