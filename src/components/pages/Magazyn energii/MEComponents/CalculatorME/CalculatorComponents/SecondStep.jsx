      ...
      <div className="">
        ...
        <div className="flex flex-col justify-between gap-5">
          ...
          <div className="flex flex-col items-start justify-start gap-2">
            ...
            >
              <i
                className={`pr-2 fa-regular ${
                  standard ? "fa-circle-check" : "fa-circle"
                }`}
              ></i>
              2000 kWh - standard
            </button>
            ...
            >
              <i
                className={`pr-2 fa-regular ${
                  niepelnosprawnosc ? "fa-circle-check" : "fa-circle"
                }`}
              ></i>
              2600 kWh - niepełnosprawność
            </button>
            <button
              onClick={() => {
                setStandard(false);
            ...
            >
              <i
                className={`pr-2 fa-regular ${
                  kartaDuzejRodziny ? "fa-circle-check" : "fa-circle"
                }`}
              ></i>
              3000 kWh - Karta Dużej Rodziny
            </button>
            <button
              onClick={() => {
                setStandard(false);
            ...
            >
              <i
                className={`pr-2 fa-regular ${
                  gospodarstwo ? "fa-circle-check" : "fa-circle"
                }`}
              ></i>
              3000 kWh - gospodarstwo rolne
            </button>
          </div>
          ...
          <div className="p-5 rounded-md shadow-md bg-gradient-to-br from-ocean-green-100 to-ocean-green-200 shadow-ocean-green-200">
            <p>
              ...
              {limit >= calculation
                ? `Nie przekraczasz progu, powyżej którego cena 1 kWh jest dużo wyższa, dlatego pod warunkiem tego samego zużycia w 2023 r. zapłacisz prawie tyle samo.`
                : `Przekraczasz o ${progWOneKwp} kWh próg, powyżej którego cena 1 kWh jest dużo wyższa. W rezultacie w 2023 roku zapłacisz o ${progWOneZl} zł więcej niż w bieżącym roku.`}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col justify-between gap-5 ">
          ...
          <p className="p-5 rounded-md shadow-md bg-gradient-to-br from-ocean-green-100 to-ocean-green-200 shadow-ocean-green-200">
            ...
            {ActivePV
              ...
              : `Czy wiesz, że fotowoltaika z magazynem energii zmniejszy Twoje opłaty do zera? Co więcej, sprzedasz dużo więcej energii niż kupisz, a to oznacza, że możesz dodatkowo zarobić nawet ${resultForSecondPage} zł.`}
          </p>
        </div>
      </div>
    </div>
