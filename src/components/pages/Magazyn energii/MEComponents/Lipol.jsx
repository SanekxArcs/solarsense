...
<section className='py-20 text-center md:text-left max-w-[1170px] mx-auto px-6 '>
    <div className='grid grid-cols-2'>
        <div className='grid place-content-center'>
            <img className=' scale-150' src={Pylotech} alt="" />
        </div>
        <div >
            <div className='flex gap-5 items-center'>
                <img src={icolifepo} alt="" />
                <h3 className='mt-5 text-4xl font-bold tracking-tight mb-2'>Technologia LiFePO4</h3>
            </div>
            
            <p  className='mb-5 text-2xl tracking-tight'>
                bez efektu pamięci
            </p>
            <p className='text-lg'>
