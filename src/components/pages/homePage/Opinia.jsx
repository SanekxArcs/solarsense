              ...
              <div key={index} className="grid items-stretch mb-6 transition-all duration-300 rounded-sm shadow-lg lg:mb-0 bg-ocean-green-50 hover:-translate-y-2 hover:shadow-xl hover:shadow-ocean-green-400">
                ...
                >
                  <picture>
                    ...
                    <img
                      src={item.photo320}
                      className="w-full h-auto bg-cover rounded-t-sm "
                      alt={item.altText}
                      loading="lazy"
                    />
                  </picture>
                  <div className="absolute top-0 bottom-0 left-0 right-0 w-full h-full overflow-hidden transition duration-300 ease-in-out bg-fixed opacity-0 hover:opacity-100">
                    <img
