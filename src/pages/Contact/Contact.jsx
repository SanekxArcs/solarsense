...
function Contact({ textToMessage, setTextToMessage }) {
  ...
  const [klientLastname, setKlientLastname] = useLocalStorageState("klientLastname", "");
        ...
        przesłania oferty."
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  disabled={!checkbox}
                  className="flex gap-2 justify-center items-center w-full px-6 py-3 font-medium leading-tight uppercase transition duration-150 ease-in-out rounded shadow-md bg-primary text-port-gore-950 hover:bg-ocean-green-400 hover:shadow-lg hover:shadow-ocean-green-400/50 focus:bg-ocean-green-400 focus:shadow-lg focus:outline-none focus:ring-2 active:bg-ocean-green-400 active:shadow-lg bg-ocean-green-400 text-md disabled:opacity-40 disabled:hover:shadow-md disabled:cursor-not-allowed"
                >
                  Wyślij
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
