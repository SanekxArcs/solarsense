  ...
  return (
    <div className="grid gap-10 mt-5">
      <div className="flex flex-col gap-5">
        <h5 className="text-xl font-bold">Bezpłatna oferta już do 1 dni</h5>
        <p>
          Wyślij formularz, a my prześlemy Ci w wiadomości mailowej szczegóły
        ...
        <div className="p-5 rounded  shadow-md bg-gradient-to-br from-ocean-green-100 to-ocean-green-200 shadow-ocean-green-200">
          <h6 className="text-xl font-medium">
            ...
            <button>
              <i className="text-base text-primary-dark-accent1 fa-solid fa-circle-info"></i>
            </button>
          </h6>
          <ul>
            <li>Oszczędności w ciągu roku: {result} zł</li>
            <li>
              Dotacja Mój Prąd 5.0: {ActivePV ? "6 000" : ""}{" "}
              {ActivePVME ? "26 000" : ""} zł{" "}
              <button>
                <i className="text-base text-primary-dark-accent1 fa-solid fa-circle-info"></i>
              </button>
            </li>
          ...
          <div className="flex gap-2">
            <p>
              Więcej informacji na temat tej kalkulacji otrzymasz w wiadomości
              mailowej.
            </p>
          </div>
        </div>
