        ...
        <section className="py-20 text-center md:text-left max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3">
            <div className="col-span-2 ">
              ...
              <h2 className="mb-5 text-4xl font-bold tracking-tight md:text-6xl xl:text-7xl text-ocean-green-300">
                Mój prąd 5.0
              </h2>
              <p>
                dofinansowanie do <b>23 000 zł</b>{" "}
              </p>
              <p className="pt-5 md:text-xl">
                <b>Chcesz by Twój dom był oszczędny i samowystarczalny?</b>{" "}
                <br /> Postaw na fotowoltaikę z magazynem energii od Solar
                Sense. Dotacja w programie "Mój Prąd 5.0" wynosi aż 23 000
                złotych.
              </p>
              <p className="pt-5 md:text-xl">
                Dotacja ta jest przeznaczona na zakup komponentów, które
                zwiększą autokonsumpcję energii elektrycznej w domu, a w
                szczególności na zakup fotowoltaiki oraz magazynu energii. W
                ramach dotacji można otrzymać do 7 000 zł na zakup fotowoltaiki
                oraz do 16 000 zł na zakup magazynu energii. Dzięki temu
                programowi możesz postawić na niezależny i oszczędny dom, który
                będzie samowystarczalny pod względem energetycznym.
              </p>
              <p className="pt-5 text-xl ">
                <b>Ile wynosi dotacja w Mój Prąd 5.0?</b>{" "}
              </p>
            </div>
            <div className="items-center justify-center hidden md:flex">
              <img loading="lazy" src={monejPanel} alt="ico money" />
            </div>
          </div>
