...
const AdditionalServices = () => {
  return (
    <section id="uzimienie" className="max-w-7xl px-6 mx-auto my-32">
      <img
        className="w-[600px] md:w-full md:max-w-7xl px-6 mx-auto my-14 border-b-2 pb-5 border-ocean-green-400"
        src={uziom}
        alt=""
      />
      <h3
      ...
      <div className="flex flex-col gap-2 py-10">
        <div className="flex justify-between px-4 py-4 font-bold rounded  ring-1 ring-ocean-green-700 bg-ocean-green-200">
          <p>Rodzaj</p>
          <p>Cena brutto</p>
        </div>
        <div className="flex justify-between gap-2 px-4 py-2 bg-white rounded  ring-1 ring-ocean-green-700 md:justify-between">
          <p>Wymiana paneli</p>
          <p>0d 250 zł</p>
        </div>
        <div className="flex justify-between gap-2 px-4 py-2 bg-white rounded  ring-1 ring-ocean-green-700 md:justify-between">
