        ...
        return (
          ...
          >
            <div
              ...
              } relative z-10 px-8 py-10 mb-10 overflow-hidden border rounded-sm hover:shadow-lg shadow-sm transition-shadow duration-300 shadow-ocean-green-200 sm:p-12 lg:py-10 lg:px-6 xl:p-12`}
            >
              <motion.span
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
